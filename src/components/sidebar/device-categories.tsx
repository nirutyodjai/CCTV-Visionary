...
const CATEGORIES: Category[] = [
  {
    ...
    items: [
      ...
      { icon: CctvBulletIcon, label: 'กล้องวงจรปิดแบบกระสุน', type: 'cctv-bullet' },
      { icon: CctvPtzIcon, label: 'กล้องวงจรปิดแบบหมุนได้', type: 'cctv-ptz' },
      { icon: NvrIcon, label: 'เครื่องบันทึกภาพ', type: 'nvr' },
  ...
  },
  {
    ...
    items: [
      ...
      { icon: WifiApIcon, label: 'จุดเชื่อมต่อไวไฟ', type: 'wifi-ap' },
      { icon: UtpCat6Icon, label: 'สายแลน', type: 'utp-cat6' },
      { icon: FiberOpticIcon, label: 'สายใยแก้วนำแสง', type: 'fiber-optic' },
